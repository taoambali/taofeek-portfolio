    ...
    >
      <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full w-[80%]">
        ...
        <div class="mt-8" v-for="skill in skills" :key="skill.id">
          <div class="flex tems-end justyify-between" data-aos="fade-right">
          ...
          <div class="mt-2 h-1 w-full bg-[#131d30] rounded-full">
            <div
              class="h-1 rounded-full bg-[green]"
      ...
      <div data-aos="flip-left">
        ...
        <div class="space-y-8 py-8" data-aos="fade-left">
          <div
            ...
            :key="element.id"
            class="flex items-center rounded-xl p-4 bg-[#111a3e] shadow-lg border border-[#f1641]"
          >
            <div class="w-1/4">
              <img
            ...
            <div class="w-3/4 pl-4">
              <h3
                class="text-2xl font-semibold uppercase text-transparent bg-clip-text bg-gradient-to-r from-priamry to-secondary"
              >
                {{ element.role }}
              </h3>
